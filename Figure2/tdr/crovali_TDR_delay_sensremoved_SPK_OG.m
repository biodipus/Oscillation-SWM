...
%     alldays = {'04-15','05-07','05-09','05-13','05-14','05-15','05-16','05-20','05-21','05-22','05-23'};
    alldays = {'04-10','04-11','04-16','04-17','04-18','04-19','04-20','04-22','04-23','04-24'}; %用于ripple 分析
end
...
%                     '_weight_mem_delay.mat'];
        ...
        if strcmp(ruletype,'repeat') || strcmp(ruletype,'mirror')
            savefile = ['C:\Wen\Project\Osc_control\Data\Result_grootsw\SPK_sw\tdr_frontal_L2_croval\tdr_mem_delay2\',ruletype, days(1:end),...
                '_weight_mem_delay.mat'];
        end
    end
